...
class AppModule(GameAppModule):
	def chooseNVDAObjectOverlayClasses(self, obj, clsList):
		if obj.windowClassName.startswith("Afx:00400000:20") and obj.windowControlID == 59648 and obj.IAccessibleRole == oleacc.ROLE_SYSTEM_CLIENT:
			try:
				clsList.remove(ContentGenericClient)
			except ValueError:
				pass
			clsList[0:0] = (Terminal, MyDisplayModelLiveText)
		elif obj.windowClassName == "Afx:00400000:0" and obj.IAccessibleRole == oleacc.ROLE_SYSTEM_CLIENT:
			clsList.insert(0, IO)
